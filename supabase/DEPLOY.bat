...
:: Secrets da API Projuris ADV
set PROJURIS_BASE_URL=https://service.projurisadv.com.br
set PROJURIS_CLIENT_ID=api_cliente_codigo_122785
set PROJURIS_CLIENT_SECRET=kQFgDRJwUTRoQ8woZTckkMOrOvu2BaQE
set DIAS_PAUTA=365
...
supabase secrets set PROJURIS_BASE_URL=%PROJURIS_BASE_URL% --project-ref %SUPABASE_PROJECT_REF% --access-token %SUPABASE_ACCESS_TOKEN%
...
supabase secrets set DIAS_PAUTA=%DIAS_PAUTA% --project-ref %SUPABASE_PROJECT_REF% --access-token %SUPABASE_ACCESS_TOKEN%
